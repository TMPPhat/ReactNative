...
// Import Context (Lưu ý đường dẫn ../components)
...
export default function CheckoutScreen() {
  ...
  const handleCheckout = () => {
    ...
    Alert.alert("Thành công", "Đơn hàng của bạn đã được đặt thành công!", [
      { 
        text: "OK", 
        onPress: () => router.replace('/orders') // Chuyển hướng về trang đơn hàng hoặc trang chủ
      }
    ]);
  };
      ...
      >
        <SafeAreaView>
          <View style={styles.headerContent}>
            <TouchableOpacity
              onPress={() => router.back()} // Dùng router.back()
